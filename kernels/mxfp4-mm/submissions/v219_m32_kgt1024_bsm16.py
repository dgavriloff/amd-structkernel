...
"""
v219: BSM=16 BSN=128 BSK=256 NW=4 NS=2 waves=2 cache=None for M<=32 K>1024.

Replaces legacy BSM=32 BSN=64 BSK=512 NW=8 NS=1 on the M=32 large-K path.
For M=32 K=2880/4096, this keeps two M-tiles and restores double-buffered
K pipelining while widening N back to 128.
"""
import torch
import triton
