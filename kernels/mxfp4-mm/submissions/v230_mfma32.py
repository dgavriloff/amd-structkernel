...
"""
v229: matrix_instr_nonkdim=32 for all fused configs. CDNA4 32x32 MFMA
processes 4x more elements per instruction vs 16x16. Gluon kernels use
32x32 natively. May improve throughput for memory-bound small-M shapes.
"""
import torch
import triton
