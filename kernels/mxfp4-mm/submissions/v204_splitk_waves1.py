...
"""
v204: Split-K path waves_per_eu from 2 to 1.

Library tuned A16WFP4_PRESHUFFLED for N=2112 K=7168 uses waves_per_eu=1.
v201 baseline has M=64 waves_per_eu=2 (kept).
"""
import torch
import triton
...
def _get_fused_config(M, N, K):
    ...
    if K > 4096:
        ...
        # waves_per_eu=1: library tuned config uses this for N=2112 K=7168
        return {
            "BLOCK_SIZE_M": 8,
            "BLOCK_SIZE_N": 128,
            "BLOCK_SIZE_K": 256,
