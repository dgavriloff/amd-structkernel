...
"""
v239: Split-K path uses BLOCK_SIZE_K=512, NUM_KSPLIT=2, BLOCK_SIZE_N=64, num_stages=2, GROUP_SIZE_M=2, num_warps=4, and waves_per_eu=0.

This keeps the BSN64 two-way split-K geometry while removing the explicit
occupancy hint to let the compiler choose on the large-K branch.
"""
import torch
import triton
