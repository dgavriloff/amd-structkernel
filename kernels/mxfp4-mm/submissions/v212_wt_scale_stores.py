...
"""
v212: .wt on M=256 quant scale stores (from .cg).

Write-through pushes scale data to L2 faster for ASM GEMM consumption.
24+ BM confirmations of -1.5 to -3.8% on M=256.
v211 baseline with cache_modifier=None for M<=32 K<=1024.
"""
import torch
import triton
