...
"""
v248: Use num_warps=2 for the M=64 fused path.

For 64x7168x2048, keep the proven 16x128x256 tile family and double-buffered
pipeline, but lower the warp count from 4 to 2 to test a lower register-
pressure operating point on the 64-row fused branch.
"""
import torch
import triton
