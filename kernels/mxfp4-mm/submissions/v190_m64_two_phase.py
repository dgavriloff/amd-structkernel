...
"""
v190: Lower FUSED_M_THRESHOLD from 64 to 32.

Route M=64 (64x7168x2048) to two-phase (quant + ASM GEMM) instead of fused
Triton preshuffle. Tuned CSV shows ASM 32x128 takes 6.81us for this shape.
Quant kernel ~3us. Total ~10us vs fused 13.3us BM.
"""
import torch
import triton
...
# M=64 routes to two-phase (quant + ASM GEMM): ASM 32x128 tuned at 6.81us
# vs fused preshuffle 13.3us BM for 64x7168x2048
