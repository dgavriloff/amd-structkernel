...
"""
v218: BSM=16 BSN=128 BSK=256 NW=4 NS=2 waves=2 cache=None for M<=32 K>1024.

Replaces BSM=32/BSN=64/BSK=512/NW=8/NS=1. For M=32 K=2880/4096:
2 M-tiles with double-buffered pipelining (NS=2) vs 1 M-tile without.
v132 tried BSM=8 for this path (+0.9%); BSM=16 untested.
"""
import torch
import triton
