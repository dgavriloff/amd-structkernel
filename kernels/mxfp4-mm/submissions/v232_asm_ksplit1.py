...
"""
v231: M=256 ASM GEMM log2_k_split=1 (from 0). Split-K=2 doubles grid
parallelism for 256x3072x1536 shape. ASM kernel has built-in atomic
reduction. Halves K per block from 768 to 384 FP4 elements.
"""
import torch
import triton
