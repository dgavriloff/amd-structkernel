...
"""
v224: M=64 fused path uses BLOCK_SIZE_K=384 (from 256).

This keeps the proven 16x128 tile family and double-buffered pipeline for the
64x7168x2048 shape while reducing K-loop iterations from 8 to 6.
"""
import torch
import triton
...
def _get_fused_config(M, N, K):
    ...
    if M <= 4:
        ...
        # M=64 (64x7168x2048): BSM=16 BSN=128 BSK=384 NW=4 NS=2
        # 4*56=224 blocks, 6 K-iters with pipelining
