...
"""
v228: Split-K path uses BLOCK_SIZE_K=512 with NUM_KSPLIT=2.

This tests the low-reduction end of the split-K tradeoff for the
16x2112x7168 shape while leaving the rest of the winning baseline unchanged.
"""
import torch
import triton
