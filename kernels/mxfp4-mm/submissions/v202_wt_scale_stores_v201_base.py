...
"""
v202: .wt on M=256 quant scale stores (from .cg) on v201 baseline.

v201 kept: M=64 waves_per_eu=2. Now adding .wt on scale stores for M=256
two-phase path. 24+ BM tests confirm -2-3% on M=256.
"""
import torch
import triton
