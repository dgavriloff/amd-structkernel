...
"""
v268: Keep the `v263` fused path and switch two-phase scale stores to `.wt`.

Preserve the best recent fused quant hint set and only change the M=256
two-phase quant kernel so block-scale writes use write-through stores.
"""
import torch
import triton
