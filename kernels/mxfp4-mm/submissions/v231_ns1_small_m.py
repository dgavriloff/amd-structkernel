...
"""
v230: num_stages=1 for M<=4, M<=8, M<=32 fused paths (from NS=2).
AMD-tuned A16WFP4_PRESHUFFLED configs all use NS=1. Reduces smem/reg
pressure for small iteration counts (2-8 K-iters with BSK=256).
"""
import torch
import triton
