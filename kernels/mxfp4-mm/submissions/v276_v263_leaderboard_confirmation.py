...
"""
v276: Queue the exact `v263` fused-path hint set for leaderboard confirmation.

Restore the strongest validated benchmark candidate unchanged so the current
leaderboard spend goes to the most credible fixed-input winner rather than an
unproven split-K reduction experiment.
"""
import torch
import triton
