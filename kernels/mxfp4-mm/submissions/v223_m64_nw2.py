...
"""
v223: M=64 fused path uses num_warps=2 (from 4).

This keeps the proven 16x128x256 tile family and num_stages=2 pipeline.
The goal is to reduce register pressure on the 64x7168x2048 shape without
changing grid shape or the current cache behavior.
"""
import torch
import triton
