...
"""
v221: waves_per_eu=3 for M=64 fused path (from 2).

Testing intermediate occupancy hint. waves=0,1,2,4 tested for M=64;
waves=3 never tried. For 224 blocks on MI355X, may optimize
register vs occupancy balance.
"""
import torch
import triton
...
def _get_fused_config(M, N, K):
    ...
    if M <= 4:
        ...
        # waves_per_eu=3: testing intermediate occupancy hint
        return {
            "BLOCK_SIZE_M": 16,
            "BLOCK_SIZE_N": 128,
            "BLOCK_SIZE_K": 256,
