...
"""
v226: M<=32 K<=1024 fused path uses waves_per_eu=1 (from 2).

This keeps the v211 cache=None improvement for the K=512 path while relaxing
the occupancy hint one step on the two M=32 leaderboard shapes.
"""
import torch
import triton
