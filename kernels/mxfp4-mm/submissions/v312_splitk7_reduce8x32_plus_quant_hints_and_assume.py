...
"""
v312: Add `tl.assume` facts on top of the split-K=7 `8x32` hint branch.

Keep the current BM-leading repaired `8x32` path and the restored contiguous
lane hints, then add only positive-extent and unit-stride assumptions.
"""
import torch
import triton
