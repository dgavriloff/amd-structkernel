...
"""
v209: Unify M<=32 config: remove K>1024 special case, use BSM=8/BSN=128/BSK=256/NW=4/NS=2/waves=2/.cg
for ALL M<=32 shapes. Legacy BSM=32/BSN=64/BSK=512/NW=8/NS=1 wasted 50% rows for M=16 shapes.
v189/v191 tried this but LB scores were unparseable. Third attempt.
"""
import torch
import triton
