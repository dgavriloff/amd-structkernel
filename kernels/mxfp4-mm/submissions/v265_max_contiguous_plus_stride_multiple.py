...
"""
v265: Combine `tl.max_contiguous` with the `v263` stride-multiple hint set.

Restore the contiguous N-lane vector hints from v258 and keep the row-stride
alignment facts from v263, without the extra v264 output-lane hint.
"""
import torch
import triton
