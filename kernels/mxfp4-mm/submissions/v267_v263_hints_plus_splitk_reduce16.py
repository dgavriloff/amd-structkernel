...
"""
v267: Combine the `v263` fused-path hints with `REDUCE_BSN=16` for split-K.

Keep the stronger `v263` fused quant stride hints unchanged and narrow only the
fp32 partial reduction tile on the large-K split-K path.
"""
import torch
import triton
