...
"""
v249: Use the BSN64 split-K=2 branch with REDUCE_BSN=16.

For the 16x2112x7168 split-K shape, keep the recent test-passing
BSK=512/NUM_KSPLIT=2/BSN=64/NS=2 geometry, but restore the smaller 16-wide
reduce tile that previously beat larger reduce tiles on this path.
"""
import torch
import triton
