...
"""
v270: Keep the `v263` fused path and remove split-K reduction padding.

Preserve the stronger fused quant stride hints from `v263`, keep the default
split-K reduction tile shape, and trim the reduction width down to the actual
number of partials instead of the next power of two.
"""
import torch
import triton
