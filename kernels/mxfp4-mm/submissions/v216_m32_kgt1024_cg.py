...
"""
v216: cache_modifier=.cg for M<=32 K>1024 path (from None).

BSM=32/BSN=64/BSK=512/NW=8 with .cg bypasses L1 for B loads.
With BSK=512, each K-iter loads 16KB B data; .cg avoids L1 thrashing.
Affects M=32 K=4096 and M=32 K=2880 LB shapes.
"""
import torch
import triton
