...
"""
v227: M=256 quant kernel: BSN=128 NW=4 NS=2 (from BSN=64 NW=2 NS=1).
Grid reduces from 192 to 96 blocks for M=256 K=1536. Larger N-tile
amortizes scale shuffle overhead. NS=2 software pipelining overlaps
bf16->fp4 quant with loads. Quant takes ~50% of M=256 total time.
"""
import torch
import triton
