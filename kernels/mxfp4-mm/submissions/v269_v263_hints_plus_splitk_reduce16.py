...
"""
v269: Keep the `v263` fused path and shrink split-K reduction tiles.

Preserve the stronger fused quant stride hints from `v263`, revert the
repeated M=256 scale-store experiment, and narrow only the 16x2112x7168
split-K fp32 partial reduction tile.
"""
import torch
import triton
