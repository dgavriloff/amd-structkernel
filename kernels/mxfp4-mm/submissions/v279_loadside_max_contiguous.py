...
"""
v279: Add only the load-side `tl.max_contiguous` hint on top of `v263`.

Keep the exact `v263` baseline intact and mark only the bf16 input lane vector
as contiguous, leaving the packed fp4 store path unchanged.
"""
import torch
import triton
