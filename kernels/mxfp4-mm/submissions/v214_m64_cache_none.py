...
"""
v214: cache_modifier=None for M=64 fused path (from .cg).

AMD library default uses null for M=64 preshuffle. v103 showed -0.8%,
v193 showed +1.8% — contradictory results on different baselines.
Re-evaluate on v211 baseline.
"""
import torch
import triton
