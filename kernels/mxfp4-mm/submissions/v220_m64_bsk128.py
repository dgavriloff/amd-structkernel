...
"""
v220: BSK=128 NW=4 NS=2 for M=64 fused path (from BSK=256).

Keeps the proven 16x128 tile family for the 64x7168x2048 shape but halves the
K chunk size, trading 8 heavier K-iterations for 16 lighter ones.
"""
import torch
import triton
