...
"""
v278: Restore the exact `v263` fused-path hint set for fresh confirmation.

Recent split-K follow-ups did not produce a stronger validated candidate, so
replay the strongest known fused-path branch unchanged before spending another
scarce leaderboard slot.
"""
import torch
import triton
