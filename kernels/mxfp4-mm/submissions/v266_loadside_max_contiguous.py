...
"""
v266: Add only the load-side `tl.max_contiguous` hint on top of the `v263` set.

Keep the v263 stride-multiple branch and add contiguity only for the bf16 load
lane vector, leaving the packed fp4 store path unchanged.
"""
import torch
import triton
