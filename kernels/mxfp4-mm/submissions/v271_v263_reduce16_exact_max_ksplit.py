...
"""
v271: Combine exact split-K reduction width with smaller reduce tiles.

Preserve the stronger fused quant stride hints from `v263`, then cut split-K
reduction overhead in both dimensions by using the actual partial count and a
narrower fp32 reduction tile on the 16x2112x7168 path.
"""
import torch
import triton
