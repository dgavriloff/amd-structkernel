...
"""
v280: Retile only the split-K reduction kernel to `REDUCE_BSM=8` and `REDUCE_BSN=32`.

Keep the current fused-path baseline intact and probe the remaining untested
split-K reduction midpoint for the 16x2112x7168 path.
"""
import torch
import triton
