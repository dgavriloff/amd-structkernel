...
"""
v229: Split-K reduce uses exact MAX_KSPLIT instead of padding to 8.

This keeps the proven 7-way split-K GEMM path and only trims the reduction
extent from padded 8 lanes down to the 7 real partials.
"""
import torch
import triton
