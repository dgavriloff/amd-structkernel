...
"""
v264: Add packed-fp4 output vector alignment on top of the `v263` hint set.

Keep the stride-alignment fused quant path and add only an alignment hint for
the packed fp4 output lane vector.
"""
import torch
import triton
