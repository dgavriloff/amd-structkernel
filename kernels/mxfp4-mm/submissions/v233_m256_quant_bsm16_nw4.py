...
"""
v233: M=256 quant kernel: BSM=16 NW=4 (from BSM=32 NW=2). Grid doubles
from 192 to 384 blocks (0.75 to 1.5 waves). BSM=64 neutral (v113),
BSM=32 current. BSM=16 doubles CU utilization for quant-bound M=256.
NW=4 hides memory latency for bf16 loads.
"""
import torch
import triton
