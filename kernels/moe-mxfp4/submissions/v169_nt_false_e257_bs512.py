...
"""
v169: Disable non-temporal loads for bs=512/E=257/d=256.
NT loads bypass L2 cache. For E=257/bs=512 with ~2 tokens/expert,
the working set may fit in L2, making temporal loads faster.
"""
import os
import functools
import torch
