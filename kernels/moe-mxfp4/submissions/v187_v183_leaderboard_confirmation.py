...
"""
v187: Resubmit the exact v183 bundle for leaderboard confirmation.
Keep the strong v176 sparse bundle, but disable use_non_temporal_load only
for bs=512/E=257, which was the best benchmark-backed variant at 121.66us.
"""
import os
import functools
import torch
