...
"""
v170: Use M64 stage1 kernel (256x64x128x128_1x4) with block_m=64 for E=257/bs=512/d=256.
DSV3 tuned CSV recommends M64+block_m=64 for E=257 token>=64 shapes.
v164 incorrectly used M32 kernel with block_m=64; this properly matches MPerBlock.
"""
import os
import functools
import torch
...
_CUSTOM_CONFIGS[_make_key(512, 256, 257)] = {
    "block_m": 64, "ksplit": 0,
    "kernelName1": _4WG_STAGE1_M64, "kernelName2": _FLYDSL_STAGE2_M16_K128,
    "run_1stage": False,
