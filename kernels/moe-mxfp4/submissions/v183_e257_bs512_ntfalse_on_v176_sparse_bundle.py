...
"""
v183: Start from the clean v176 sparse-E257 bundle and disable
non-temporal loads only for bs=512/E=257.
This isolates the bs512 load-policy choice without carrying forward the
regressed bs16 NT change or the block_m=64 confounder.
"""
import os
import functools
import torch
