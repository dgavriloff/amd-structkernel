...
"""
v163: Add use_non_temporal_load=True for E=33 CK 2-stage shapes.
NT loads bypass L2 cache for weight reads, reducing cache pressure.
"""
import os
import functools
import torch
...
_CUSTOM_CONFIGS[_make_key(128, 512, 33)] = {
    ...
    "run_1stage": False,
    "use_non_temporal_load": True,  # v163: bypass L2 cache for weight reads
}
...
_CUSTOM_CONFIGS[_make_key(512, 2048, 33)] = {
    ...
    "run_1stage": False,
    "use_non_temporal_load": True,  # v163
}
