...
"""
v184: FlyDSL stage2 t16x256x128_atomic for E=33 shapes. tile_n=256 halves
the number of N-dimension tiles from 56 to 28 for stage2 down GEMM (N=7168),
reducing tile launches and improving CU utilization. tile_k=128 unchanged.
"""
import os
import functools
import torch
