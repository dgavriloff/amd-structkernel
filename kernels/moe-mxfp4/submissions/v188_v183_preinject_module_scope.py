...
"""
v188: Keep the exact v183 kernel bundle, but pre-inject the fused_moe config
monkeypatches at module load instead of checking _inject_configs() on every
custom_kernel invocation.
This isolates a small Python-path optimization on top of the best benchmarked
kernel mix.
"""
import os
import functools
