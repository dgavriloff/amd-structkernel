...
"""
v153: cktile_moe block_m=32 ksplit=2 for bs=128/E=257 and bs=16/E=257.
Larger block_m may better utilize hardware wavefronts.
"""
import os
import functools
import torch
...
_CUSTOM_CONFIGS[_make_key(16, 256, 257)] = {
    "block_m": 32,  # v153: try block_m=32 (was 16)
    "ksplit": 2,
    "kernelName1": "",
    "kernelName2": "",
    "run_1stage": False,
...
# bs=128/E=257/d=256: cktile_moe block_m=32 ksplit=2 (v153)
