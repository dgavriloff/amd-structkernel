...
"""
v181: Start from v180 and change bs=512/E=257 to block_m=64.
This keeps the stronger sparse-E257 bundle intact and isolates whether
coarser sorting granularity helps the dominant bs512 sparse shape.
"""
import os
import functools
import torch
