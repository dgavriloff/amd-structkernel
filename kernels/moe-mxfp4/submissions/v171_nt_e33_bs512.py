...
With ~15.5 tokens/expert, weight matrices are streamed once per block - NT
loads avoid polluting L2. Now tested with inline pipeline (pre-alloc overhead removed).
"""
import os
import functools
import torch
