...
"""
v182: Start from the clean v176 sparse-E257 bundle and set bs=512/E=257
to block_m=64.
This isolates bs512 sorting granularity without carrying forward the
regressed bs16 non-temporal-load change from v180.
"""
import os
import functools
import torch
