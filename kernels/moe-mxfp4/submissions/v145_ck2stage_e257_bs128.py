...
"""
v145: Remove ksplit=2 overrides for E=257 bs=128 shape.
Let it fall through to DSV3 tuned CSV config (CK 2-stage, block_m=32,
1-WG kernels). The CSV was tuned on the actual hardware - may be better
than our heuristic ksplit=2 override.
Also try CK 2-stage + FlyDSL stage2 for E=257 bs=128.
"""
import os
import functools
import torch
...
_1WG_STAGE1 = "moe_ck2stages_gemm1_64x32x32x128_1x1_MulABScaleShuffled_v3_Nswizzle0_Quant3_MulRoutedWeight0_silu_FP4X2_FP4X2_B16"
_1WG_STAGE2 = "moe_ck2stages_gemm2_64x32x32x128_1x1_MulABScaleExpertWeightShuffled_v1_Nswizzle0_Quant3_MulRoutedWeight1_FP4X2_FP4X2_B16"
...
# bs=128/E=257/d=256: CK 2-stage with FlyDSL stage2 (v145)
# Remove ksplit=2 override, use CK stage1 from tuned CSV + FlyDSL stage2.
