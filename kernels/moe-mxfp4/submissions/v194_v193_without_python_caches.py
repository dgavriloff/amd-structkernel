...
"""
v194: Remove the Python-side sorting and CK Tile stage1 buffer caches while
keeping the v193 mode-adaptive dispatch policy.
...
This isolates whether Python-side buffer reuse is helping or hurting on this
server while preserving the same kernel dispatch decisions.
"""
import gc
import os
