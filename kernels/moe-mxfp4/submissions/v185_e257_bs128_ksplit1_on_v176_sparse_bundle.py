...
"""
v185: Start from the clean v176 sparse-E257 bundle and set
bs=128/E=257 to ksplit=1.
This isolates whether the bs128 sparse path is overpaying split-K
reduction overhead on the stronger bundle.
"""
import os
import functools
import torch
