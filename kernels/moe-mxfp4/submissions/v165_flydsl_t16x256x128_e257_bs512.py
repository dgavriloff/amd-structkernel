...
"""
v165: FlyDSL stage2 t16x256x128_atomic for bs=512/E=257/d=256.
Keep the current best configs everywhere else and widen only stage2 tile_n
for the sparse E=257, bs=512 shape.
"""
import os
import functools
import torch
...
_CUSTOM_CONFIGS[_make_key(512, 256, 257)] = {
    ...
    "kernelName2": _FLYDSL_STAGE2_M16_N256_K128,  # v165: widen tile_n to 256
    "run_1stage": False,
