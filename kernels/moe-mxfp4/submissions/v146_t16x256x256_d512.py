...
"""
v146: FlyDSL stage2 t16x256x256_atomic for bs=512/E=33/d=512.
For d_expert=512: stage2 K=512, tile_k=256 means 2 K-tiles (vs 4 with tile_k=128).
tile_n=256 means 28 N-tiles (vs 56 with tile_n=128). Fewer tiles = less overhead.
"""
import os
import functools
import torch
...
# Register t16x256x256 for stage2 (not in default registration)
...
_CUSTOM_CONFIGS[_make_key(512, 512, 33)] = {
    ...
    "ksplit": 0,
    "kernelName1": _4WG_STAGE1_M128,
    "kernelName2": _FLYDSL_STAGE2_M16_N256_K256,  # v146: t16x256x256 for d=512
    "run_1stage": False,
}
