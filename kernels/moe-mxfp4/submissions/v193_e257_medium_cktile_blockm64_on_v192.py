...
"""
v193: Keep the v192 mode-adaptive dispatch policy, but force block_size_M=64
for the E=257 medium-shape CK Tile path (M<=128).
...
This isolates the later sibling v224 probe on top of the clean v192/V193-style
dispatch split rather than the older local sparse NT/metadata branches.
"""
import gc
import os
