...
"""
v180: Start from the v176 sparse-E257 bundle and add explicit
use_non_temporal_load=True to the bs=16/E=257 cktile block_m=32 path.
This isolates whether the tiny sparse E257 shape wants the same NT behavior
that already helped bs128 and bs512.
"""
import os
import functools
import torch
