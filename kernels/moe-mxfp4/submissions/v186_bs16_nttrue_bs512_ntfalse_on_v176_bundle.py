...
"""
v186: Combine the two best recent E257 benchmark signals on top of v176:
enable use_non_temporal_load=True for bs=16/E=257, and disable
use_non_temporal_load for bs=512/E=257.
This tests whether the tiny sparse shape and the large sparse shape want
opposite load policies while keeping the strong bs128 bundle unchanged.
"""
import os
import functools
import torch
