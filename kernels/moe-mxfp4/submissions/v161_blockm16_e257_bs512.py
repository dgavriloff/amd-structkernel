...
"""
v161: block_m=16 for bs=512/E=257/d=256 (was block_m=32).
With ~2 tokens/expert avg, block_m=16 better matches sparse distribution.
"""
import os
import functools
import torch
...
_CUSTOM_CONFIGS[_make_key(512, 256, 257)] = {
    "block_m": 16,  # v161: was 32, try 16 for sparse token distribution
    "ksplit": 0,
