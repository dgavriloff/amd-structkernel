...
"""
v137: FlyDSL t16x128x128_atomic stage2 for d=512 (tile_m=16).
tile_m=16 helped d=2048 in v134. Try same for d=512.
d=512 currently uses t32x128x128 (v125). t16 = more M-parallelism.
"""
import os
import functools
import torch
...
_CUSTOM_CONFIGS[_make_key(512, 512, 33)] = {
    ...
    "ksplit": 0,
    "kernelName1": _4WG_STAGE1_M128,
    "kernelName2": _FLYDSL_STAGE2_M16_N128_K128,  # v137: tile_m=16 for d=512
    "run_1stage": False,
}
