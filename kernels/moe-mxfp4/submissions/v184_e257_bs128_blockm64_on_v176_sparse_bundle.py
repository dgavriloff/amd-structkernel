...
"""
v184: Start from the clean v176 sparse-E257 bundle and set
bs=128/E=257 to block_m=64.
This isolates a safer bs128 sorting-granularity change after the
bs512 block_m=64 branch proved unstable.
"""
import os
import functools
import torch
