...
"""
v156: Use a16w8 persistent page_size=16 only for bs=32,kv=1024.
Based on the recovered aiter hybrid baseline.

The earlier ps=16 experiment for both bs=32 and bs=64 failed on bs=64 only.
This isolates the larger page size to the medium 1k batch while leaving the
known-safe bs=64/256 routes unchanged.
"""
