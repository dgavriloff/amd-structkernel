...
"""
v164: Revert the broken kv_granularity override and keep the last passing 1k-only routes.
...
This removes the v162 kv_granularity=32 regression while preserving the two
1k-only routing changes that each returned test PASS asynchronously.
"""
