...
"""
v158: Route bs=256,kv=1024 to bf16_persist instead of a16w8.
Based on the recovered hybrid baseline.

This isolates the heaviest 1k shape onto the bf16 persistent path, which may
benefit from fewer pages and simpler accumulation without disturbing the
smaller 1k cases or the proven 8k bf16 route.
"""
