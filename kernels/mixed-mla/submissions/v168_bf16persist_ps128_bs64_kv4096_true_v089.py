...
"""
v168: Use bf16_persist page_size=128 only for bs=64,kv>=4096 on the true v089 baseline.
Keep the recovered valid routing everywhere else:
- bf16 non-persistent for bs<=4,kv<=1024
- bf16 persistent page_size=64 for bs<=32 or bs=256 8k shapes
- default a16w8 persistent for all 1k shapes except the tiny bf16 case
"""
