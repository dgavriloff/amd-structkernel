...
"""
v162: Route bs=256,kv=1024 to bf16_persist with page_size=128 and kv_granularity=32.
Based on the recovered hybrid baseline.

This isolates the now-confirmed bs=256 1k large-page route and tests whether it
improves further when metadata work chunks stay at 32 instead of expanding to
match page_size=128. All smaller 1k shapes remain on their established routes.
"""
