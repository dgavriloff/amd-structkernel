...
"""
v163: Combine the two passing 1k-only routes on top of the refined bs=256 bf16 path.
Based on the recovered hybrid baseline.

1. Use a16w8 persistent page_size=16 only for bs=32,kv=1024.
2. Route bs=256,kv=1024 to bf16_persist with page_size=128 and kv_granularity=32.

This keeps bs=64 and all 8k shapes unchanged while testing whether the passing
medium and large 1k tweaks compose cleanly.
"""
