...
"""
v151: Persistent-only hybrid baseline with bf16_persist page_size=128 only for bs=256,kv=1024.
- Keep the corrected persistent-only routing.
- Target the heaviest 1k shape, which already uses bf16 persistent in the hybrid baseline.
- Leave all 8k shapes on the proven page_size=64 configuration.
"""
