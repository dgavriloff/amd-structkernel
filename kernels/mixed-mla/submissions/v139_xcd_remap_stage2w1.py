...
"""
v139: Add XCD-aware stage1 remap on top of the restored v123 Triton baseline.
- Remap stage1 program IDs so heads sharing the same KV split land on the same XCD.
- Aim for better L2 reuse of shared MQA KV tiles across the 16 query heads.
- Reduce stage2 to one warp because the split-reduction kernel is lightweight.
"""
