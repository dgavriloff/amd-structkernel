...
"""
v146: Use non-persistent a16w8 for kv=1024 shapes except the tiny bs<=4 case.
- kv=1024 has short loops, so persistent metadata/page setup can dominate runtime.
- The non-persistent fp8 path avoids page remapping and lets aiter autotune splits directly.
- Keep bf16 non-persistent for bs<=4,kv=1024 and bf16 persistent for all kv>=4096.
"""
