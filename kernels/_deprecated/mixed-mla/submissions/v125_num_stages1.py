...
"""
v125: num_stages=1 for stage1 to reduce pipelining overhead on short loops.
- num_stages=1 (was 2): for kv=1024 with NSPLIT=8, each split does only 2 iterations.
- Keep all caching from v123.
"""
