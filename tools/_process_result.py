...
def main():
    ...
    if mode == 'test':
        ...
        if improved:
            ...
            # Copy the snapshot (not submission.py, which may have moved on)
            ...
            print(f'[SUBMIT RESULT] v{version} leaderboard REVERT {score:.2f}µs ({change} vs v{best_version} @ {best_score}µs)')
