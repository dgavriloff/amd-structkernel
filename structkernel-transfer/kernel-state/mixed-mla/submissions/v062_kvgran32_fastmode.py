...
"""
v062: kv_granularity=32 for all persistent paths with fast_mode=True.
Based on v057.

v048 tried kv_granularity=32 without fast_mode (-0.7% within noise).
fast_mode=True may interact differently with larger granularity (coarser work distribution).
"""
