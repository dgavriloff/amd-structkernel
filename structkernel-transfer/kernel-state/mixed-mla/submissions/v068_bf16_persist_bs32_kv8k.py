...
"""
v068: Extend bf16_persist to bs<=32,kv>=4096.
Based on v057.

v067 showed bs=32,kv=8k: 28.9µs (was 30.2µs, -4.3%) with bf16_persist.
LB failure in v067 was due to pre-existing page_size=8 flakiness at bs=64,kv=1024,
not the bf16 change itself. bf16 has better tolerance than fp8.
"""
