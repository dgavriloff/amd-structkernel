...
"""
v039: a16w8 page_size=8 for kv=1024 (bs>=64 only).

v034 (page_size=4) failed secret leaderboard but page_size=2 passed.
Try page_size=8 for bs>=64,kv=1024 only (128 pages, 4 pages/split).
If tolerance holds, this could halve bs=256,kv=1k from 54µs.
"""
