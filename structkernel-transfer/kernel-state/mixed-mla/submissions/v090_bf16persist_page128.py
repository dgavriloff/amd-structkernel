...
"""
v090: bf16_persist page_size=128 for ALL kv>=4096.
Based on v089.

v089 showed page_size=64 gives -17.4% vs v057. Push to 128.
For bs=256,kv=8k: 64 pages (ps=128) vs 128 pages (ps=64).
page_size must be power of 2 (kernel uses log2(page_size)).
"""
