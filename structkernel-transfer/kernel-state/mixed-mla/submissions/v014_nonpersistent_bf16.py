...
"""
v014: Non-persistent bf16 + persistent fp8.

Changes from v009:
- bf16 path: use non-persistent mode (no metadata, auto-tuned splits)
  This avoids persistent scheduling overhead for small shapes.
- fp8 path: keep persistent mode with 32 splits (proven optimal)
"""
