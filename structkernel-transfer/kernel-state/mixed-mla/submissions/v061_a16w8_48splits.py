...
"""
v061: Per-shape NUM_KV_SPLITS tuning with fast_mode=True.
Based on v057.

v060 tried 48 splits for ALL kv>=4096 shapes: bs=4,kv=8k regressed +20.8% (bf16_persist with small batch).
v061: Only use 48 splits for a16w8 kv>=4096 (bs>=32). Keep 32 for bf16_persist (bs=4).
"""
...
def _get_cached_bf16_persist(batch_size, kv_seq_len, q_total, qo_indptr, kv_indptr):
    ...
    page_size = 16
    num_kv_splits = NUM_KV_SPLITS_DEFAULT  # bf16_persist is for bs<=4, keep 32 splits
