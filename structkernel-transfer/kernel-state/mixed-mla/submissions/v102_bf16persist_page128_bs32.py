...
"""
v102: bf16_persist page_size=128 for bs<=32,kv>=4096.
Based on v089.

v090 tested ps=128 for ALL kv>=4096 and failed at bs=64 and bs=256.
But bs=4 and bs=32 were not specifically reported as failing.
Smaller batches have less accumulation error.
Try ps=128 only for bs<=32, keep ps=64 for bs>=64.
"""
