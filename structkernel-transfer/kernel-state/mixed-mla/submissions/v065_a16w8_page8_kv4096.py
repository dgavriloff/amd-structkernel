...
"""
v065: page_size=8 for kv>=4096 a16w8 shapes (was 16).
Based on v057.

kv=8192 with page_size=16 gives 512 pages/batch = 16 pages/split.
page_size=8 gives 1024 pages/batch = 32 pages/split — finer granularity
may improve CU utilization for large batch kv=8k shapes.
page_size=8 is proven reliable for kv=1024 (v039, v042b).
"""
