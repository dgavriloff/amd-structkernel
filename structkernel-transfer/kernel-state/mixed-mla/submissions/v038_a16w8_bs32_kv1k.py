...
"""
v038: Extend a16w8 to bs=32,kv=1024 (page_size=2).

v037 showed a16w8 for bs=64,kv=1k (-20.1%). Try same for bs=32,kv=1k
which was bf16 non-persistent at 30.6µs.
"""
...
def _get_path(batch_size, kv_seq_len):
    ...
    if batch_size <= 4:
        return 'bf16'
    # a16w8 for all remaining shapes
    return 'a16w8'
