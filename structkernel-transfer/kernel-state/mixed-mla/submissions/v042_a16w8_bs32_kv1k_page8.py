...
"""
v042: a16w8 page_size=8 for bs=32,kv=1024.

v038 tried page_size=2 for bs=32,kv=1k and got +11.8%. But page_size=8
was much better for bs>=64 (v039). Try page_size=8 for bs=32,kv=1k too.
128 pages per batch element, 4096 total pages, 128 pages/split.
"""
...
def _get_path(batch_size, kv_seq_len):
    ...
    # bf16 non-persistent for small batch shapes
    if batch_size <= 4:
        return 'bf16'
