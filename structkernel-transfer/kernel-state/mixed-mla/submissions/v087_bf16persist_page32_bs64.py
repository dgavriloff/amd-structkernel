...
"""
v087: Extend bf16_persist page_size=32 to bs<=64,kv>=4096.
Based on v086.

v086 showed bf16_persist page_size=32 gives -26.5% at bs=32,kv=8k.
Test if the same benefit applies at bs=64,kv=8k (currently 34.5µs with a16w8 ps=16).
Risk: bf16 2x bandwidth cost may outweigh page_size benefit at larger batches.
"""
