...
"""
v081: a16w8 page_size=4 for bs=32,kv=1024 with fast_mode=True.
Based on v057.

v055 tested page_size=4 before fast_mode and got +39.7% regression.
fast_mode=True changes metadata scheduling and may reduce page_size=4 overhead.
bs=32,kv=1024 with page_size=4 gives 256 pages, 8 pages/split with 32 splits.
"""
...
def _get_cached_a16w8(batch_size, kv_seq_len, q_total, qo_indptr, kv_indptr):
    ...
    if kv_seq_len >= 4096:
        ...
        page_size = 4  # Test page_size=4 for bs=32 with fast_mode=True
