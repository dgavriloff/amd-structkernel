...
"""
v036: Extend a16w8 to all shapes (except bf16 small batch).

v035 showed a16w8 page_size=2 works for kv=1024. Now try a16w8 for all
remaining shapes including kv=8192 with page_size=16. Avoids Q quantization
overhead (saves ~5-10µs per call for fp8 quant). Previous a16w8+kv=8k
regression (v026) was with page_size=1; page_size=16 may behave differently.
"""
