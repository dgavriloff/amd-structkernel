...
"""
v018: Non-persistent fp8 for bs=256,kv=8k only.

Changes from v016:
- For bs=256,kv=8192: use non-persistent fp8 (auto-tuned 7 splits)
  instead of persistent fp8 (32 splits).
  v015 showed tolerance issues at bs=64,kv=8k but bs=256,kv=8k might be safer.
  This shape is the biggest contributor to geomean (295µs).
...
def _should_use_nonpersist_fp8(batch_size, kv_seq_len):
    """Use non-persistent fp8 for specific shapes where tolerance is safe."""
