...
"""
v047: Add bf16 persistent with page_size=16 for bs=4,kv>=4096.
Based on v042b + v045's bf16_persist concept.

bs=4,kv=8k currently uses bf16 non-persistent at 35.2µs.
v045 showed 29.7µs with bf16 persistent page_size=16 but failed
at bs=64,kv=1k (flaky page_size=8). Now the a16w8 paths handle
all non-bf16 shapes independently, so adding bf16 persistent for
bs=4,kv=8k should not interfere.
"""
