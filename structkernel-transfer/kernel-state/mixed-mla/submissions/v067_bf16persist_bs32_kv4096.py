...
"""
v067: bf16 persistent (a16w16) for bs<=32,kv>=4096 (extending from bs<=4).
Based on v057.

v047 showed bf16_persist is best for bs=4,kv=8k (19.2µs).
v059 tried bs=32,kv=8k bf16_persist and got 29.2µs (was 30.2µs, -3.3%)
but geomean regressed from noise. Retrying in a cleaner run.
a16w16 avoids fp8 dequant overhead in inner loop.
"""
