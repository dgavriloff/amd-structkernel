...
"""
v043: a16w8 page_size=4 for bs=32,kv=1024.

page_size=8 at bs=32,kv=1k gave 21.4µs (-28%) but public leaderboard failed
at bs=64,kv=1k (flaky). Try page_size=4 for bs=32 only (256 pages/batch,
8 pages/split) which should have better tolerance.
"""
