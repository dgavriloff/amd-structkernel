...
"""
v059: Extend bf16 persistent page_size=16 to bs<=32,kv>=4096.
Based on v057.

v057 showed bf16_persist with fast_mode=True is very fast for bs=4,kv=8k (19.2µs).
Test if bf16 persistent is also better than a16w8 for bs=32,kv=8k.
a16w8 currently at 30.2µs for that shape. bf16 avoids fp8 quantization overhead
and with fast_mode=True may have better scheduling.
"""
