...
"""
v088: Extend bf16_persist page_size=32 to ALL kv>=4096 (including bs=256).
Based on v087.

v087 showed bf16_persist page_size=32 benefits bs<=64,kv>=4096.
For bs=256,kv=8k: bf16 reads 2.4GB vs fp8 1.2GB, but page_size=32 vs 16
halves page table overhead. At 256 batch items, persistent scheduler
distributes work across 304 CUs efficiently.
"""
