...
"""
v037: Extend a16w8 to bs=64,kv=1024 (page_size=2).

v036 showed a16w8+page_size works great. Now try extending a16w8 to
bs=64,kv=1024 which was previously bf16 non-persistent at 43.8µs.
a16w8+page_size=2 may be faster due to persistent scheduling.
"""
