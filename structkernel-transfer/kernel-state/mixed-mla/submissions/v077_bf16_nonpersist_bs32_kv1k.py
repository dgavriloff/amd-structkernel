...
"""
v077: bf16 non-persistent for bs=32,kv=1024.
Based on v057.

Currently bs=32,kv=1024 uses a16w8 persistent page_size=8 (20.7us).
bf16 non-persistent is faster for bs=4,kv=1k (20.0us vs 20.2us a16w8).
Test if same advantage applies to bs=32,kv=1024.
"""
