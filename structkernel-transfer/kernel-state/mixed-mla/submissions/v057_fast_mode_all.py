...
"""
v057: fast_mode=True for ALL persistent paths.
Based on v047.

v051 tried fast_mode=True only for bs>=128,kv>=4096 (-0.7% within variance).
But aiter's own test code uses fast_mode=True for ALL persistent shapes.
fast_mode affects metadata scheduling — with uniform batch sizes (all kv_seq_len equal),
it may produce a more efficient work distribution across all CUs.
"""
