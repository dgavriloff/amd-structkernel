...
"""
v103: bf16_persist page_size=128 for bs=32,kv>=4096 only.
Based on v089.

v102 tested ps=128 for bs<=32 — failed at bs=4,kv=8k (element 2,*,446).
bs=4 has only 4 batch elements, so 1 bad element = 16 head errors.
bs=32 has more averaging across batches, may pass tolerance.
Keep ps=64 for bs<=4 and bs>=64.
"""
