...
"""
v091: bf16_persist for ALL shapes. page_size=64 for kv>=4096, page_size=32 for kv<=1024.
Based on v089.

v089 showed bf16_persist page_size=64 gives -17.4% vs v057 for kv>=4096.
Now test bf16_persist for kv=1024 shapes too (currently a16w8 persistent).
For kv=1024 use page_size=32 (1024/32=32 pages per batch).
"""
