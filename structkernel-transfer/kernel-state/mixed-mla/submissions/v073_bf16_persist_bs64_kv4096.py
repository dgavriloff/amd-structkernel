...
"""
v073: bf16 persistent (a16w16) for bs=64,kv>=4096.
Based on v057.

v067/v068 tested bf16_persist for bs<=32,kv>=4096 and found within noise.
Not yet tested for bs=64 specifically. bf16 avoids fp8 dequant overhead
at the cost of 2x bandwidth. For bs=64,kv=8k the compute-to-bandwidth
ratio may favor bf16.
"""
