...
"""
v009: Hybrid bf16/fp8 with refined threshold.

Changes from v008:
- bf16 path for: bs <= 4 (all kv), and bs <= 32 with kv <= 1024
- fp8 path for everything else
- Both paths use cached metadata and output buffers
"""
