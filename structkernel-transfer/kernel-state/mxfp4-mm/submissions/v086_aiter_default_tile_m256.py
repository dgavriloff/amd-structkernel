...
"""
v086: Use aiter default kernel selection for M>64 two-phase path.

v077 hardcodes 32x128 ASM kernel for all two-phase shapes, but this was
optimized for small M. For M=256, aiter's heuristic may pick a larger tile
(e.g., 256x256) that better matches the shape. Aiter baseline beats us on
256x3072x1536 (12.2µs vs 13.0µs), suggesting 32x128 is suboptimal there.
"""
import torch
import triton
...
def custom_kernel(data: input_t) -> output_t:
    ...
    if buf['mode'] == 'fused':
        ...
        gemm_a4w4_asm(
            ...
            B_scale_sh,
            buf['gemm_out'],
            "",  # Let aiter heuristic pick optimal tile for M>64
            None,
            1.0,
            0.0,
            True,
