...
"""
v053: All-two-phase path (leaderboard correctness fix).
Fused preshuffle GEMM (gemm_a16wfp4_preshuffle) consistently fails leaderboard secret
tests for M=4, M=16, and M=32. Use two-phase path (Triton quant + ASM GEMM) for all shapes.
"""
import torch
import triton
