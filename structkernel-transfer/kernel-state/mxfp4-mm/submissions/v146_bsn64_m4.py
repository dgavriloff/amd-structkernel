...
"""
v146: BSN=64 NW=2 for M<=4 to improve CU utilization.

Hypothesis: M=4 uses BSN=128 NW=4 giving 23 blocks (0.09 waves on 256 CUs).
BSN=64 NW=2 gives 45 blocks (0.18 waves) — nearly double CU saturation.
Matches the BSN/NW pattern that helped M<=32 K<=1024 shapes in v021.

Target: 4x2880x512 (6.16us LB).
"""
import torch
import triton
