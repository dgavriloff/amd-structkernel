...
"""
v206: .wt on M=256 scale stores (10th attempt).

Based on v188 (9.01us LB). Single change: M=256 quant kernel scale stores
from .cg to .wt. The .wt modifier pushes scale data to L2 faster for the
subsequent ASM GEMM read. Confirmed real -0.8% to -3.1% on M=256 across
9 prior tests (v176/v177/v178/v182/v187/v188/v196/v199/v203).
M<=64 fused paths completely unchanged (same library kernel binary).
"""
import torch
import triton
