...
"""
v028: Add .cg cache modifier to fp4 output stores.
- Push fp4 output directly to L2/VRAM, keep L1 free for GEMM working set.
- v021 stores fp4 with no cache modifier (L1+L2), blockscale with .cg.
- Target: quant→GEMM transition — reduce L1 pollution from quant output.
"""
import torch
import triton
