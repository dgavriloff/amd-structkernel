...
"""
v077: Hybrid fused M<=64, two-phase M>64.

v076 showed fused with BSK=256 num_stages=2 works for M=64:
  64x7168x2048: 14.2µs (two-phase) → 13.3µs (fused) = -6.3%
But M=256 regresses badly: 12.9µs → 16.2µs (+25.6%).

This version: extend fused threshold from M<=32 to M<=64.
M>64 (M=256) stays on two-phase path.
"""
import torch
import triton
