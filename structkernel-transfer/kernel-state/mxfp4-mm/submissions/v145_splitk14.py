...
"""
v145: split-K=14 for 16x2112x7168 to double CU utilization.

Hypothesis: Current split-K=7 gives 238 blocks (0.93 waves on 256 CUs).
split-K=14 gives 476 blocks (1.86 waves), each doing 2 K-iters instead of 4.
Better CU saturation should reduce GEMM time for this shape.
EVEN_K conditions met: K_kernel=3584, SPLITK_BLOCK_SIZE=512, BSK=256.
