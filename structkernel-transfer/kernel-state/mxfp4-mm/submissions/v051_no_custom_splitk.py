...
"""
v051: Remove custom split-K=7 config for 16x2112x7168 (leaderboard correctness fix).
Both BSM=4 for M=4 and NUM_KSPLIT=7 for 16x2112x7168 fail leaderboard secret tests.
Fix: Route M<=4 to two-phase path, remove custom 16x2112x7168 config (use library default).
Keep BSM=16 BSN=128 for M=32.
"""
import torch
import triton
