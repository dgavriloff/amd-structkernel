...
"""
v182: .wt (write-through) cache modifier on M=256 quant fp4 stores.

v176/v177 showed consistent -1.5% on M=256 shape (13.0us vs 13.2us) across
multiple runs. Write-through bypasses L1, making quant data available in L2
faster for the subsequent ASM GEMM kernel. Previous attempts were geomean-neutral
due to ~2-3% LB noise on other shapes — trying again for a favorable noise outcome.
"""
import torch
import triton
