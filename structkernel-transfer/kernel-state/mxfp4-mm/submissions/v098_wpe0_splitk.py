...
"""
v098: waves_per_eu=0 for split-K path to let compiler choose occupancy.

Hypothesis: waves_per_eu=1 limits the compiler to 1 wave per EU.
With 238 blocks and 256 CUs, only 0.93 waves — slightly under full
utilization. With waves_per_eu=0 (auto), the compiler can spill fewer
registers and potentially schedule 2 waves per EU if register pressure
allows. This could improve latency hiding.
