...
"""
v155: Enable AMDGCN_USE_BUFFER_OPS=1 Triton env var.

Hypothesis: AMDGCN_USE_BUFFER_OPS=1 enables buffer descriptor-based
memory operations in the Triton AMDGPU backend for gfx950 (MI355X).
Buffer ops use hardware address generation, potentially reducing VALU
pressure for both fused preshuffle and quant kernels. Known to cause
issues on MI300 (gfx942) but MI355X (gfx950) may benefit.
"""
import os
