...
"""
v133: BSK=128 for M<=32 K<=1024 shapes to enable deeper pipelining.

Hypothesis: With BSK=256 and K=512, each block does 2 K-iterations.
BSK=128 doubles to 4 iterations, enabling more effective software pipelining
with num_stages=2 (prefetch iteration i+1 during iteration i).
Smaller per-iteration tile reduces register pressure.
