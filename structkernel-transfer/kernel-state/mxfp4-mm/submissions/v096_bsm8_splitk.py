...
"""
v096: BSM=8 for 16x2112x7168 split-K path.

Hypothesis: With BSM=16, grid = 7*1*17 = 119 blocks. With BSM=8,
grid = 7*2*17 = 238 blocks — nearly saturating 256 CUs (0.93 waves).
Each block handles 8 rows instead of 16, halving per-block work but
doubling CU utilization. The reduce kernel stays BSN=16 but gets 2
M-tiles -> 264 blocks.
