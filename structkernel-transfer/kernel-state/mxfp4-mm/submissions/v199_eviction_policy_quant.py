...
"""
v199: Test eviction_policy="evict_first" on M=256 quant kernel A loads.

Hypothesis: Triton's eviction_policy parameter may generate different ISA than
cache_modifier=".cg" on ROCm/gfx950. eviction_policy="evict_first" tells the
cache to prefer evicting this data early (loaded once, consumed once). This is
semantically similar to .cg but may use a different hardware mechanism. Never
