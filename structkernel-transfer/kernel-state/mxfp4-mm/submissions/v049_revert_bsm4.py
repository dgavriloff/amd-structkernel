...
"""
v049: Revert BSM=4 to BSM=8 for M<=4 (leaderboard correctness fix).
BSM=4 caused mismatches on M=4 leaderboard tests. Keep all other v047 changes:
BSM=16 BSN=128 for M=32, split-K=7 BSK=256 for 16x2112x7168.
"""
import torch
import triton
