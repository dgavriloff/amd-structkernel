...
"""
v047: Try BSK=256 with split-K=7 for deeper pipelining on 16x2112x7168.
v046 used BSK=512 split-K=7 (2 K-iters). BSK=256 gives 4 K-iters per block,
more opportunities for software pipelining to hide memory latency.
Grid stays at 119 blocks. Each block processes 4x256=1024 elements of K (per split).
"""
import torch
import triton
