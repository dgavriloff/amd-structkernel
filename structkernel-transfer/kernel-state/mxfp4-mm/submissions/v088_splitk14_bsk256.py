...
"""
v088: Split-K=14 BSK=256 for 16x2112x7168.

v077 uses split-K=7 BSK=256 → 119 blocks, 4 K-iters, 0.46 waves.
Split-K=14 BSK=256 → 238 blocks, 2 K-iters, 0.93 waves.
Double CU utilization while still enabling pipelining (2 K-iters + NS=2).
v046 showed split-K=14 was bad with BSK=512 (1 K-iter, no pipelining).
But BSK=256 gives 2 K-iters, so pipelining is still possible.
"""
import torch
import triton
