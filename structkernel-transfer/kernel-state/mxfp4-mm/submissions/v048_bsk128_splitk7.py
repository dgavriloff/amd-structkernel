...
"""
v048: Try BSK=128 with split-K=7 for 8 K-iterations (deeper pipelining).
v047 used BSK=256 (4 K-iters). BSK=128 gives 8 K-iters, even more
pipelining opportunities. Risk: per-iteration overhead may dominate.
"""
import torch
import triton
