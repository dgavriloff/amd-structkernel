...
"""
v095: REDUCE_BSN=8 for even more CU utilization in reduce kernel.

Hypothesis: v093 used REDUCE_BSN=16 (132 blocks). With REDUCE_BSN=8,
we get 264 blocks — better CU utilization for 256 CUs (1.03 waves vs 0.52).
Each block does less work but we have more parallelism.

Target: 16x2112x7168 shape (12.5us LB).
"""
import torch
import triton
...
def _prepare_splitk_dispatch(M, N, K, config, device):
    ...
    REDUCE_BSM = 16
    REDUCE_BSN = 8  # Even smaller blocks for more CU utilization
