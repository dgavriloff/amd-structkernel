...
"""
v108: FlyDSL t64x128x256_atomic stage2 for d=2048 with block_m=128.
Previous test (v054) used block_m=64 and tile_m=64 was worse than tile_m=32.
With block_m=128, there are fewer sorted_expert_ids blocks (66 vs 99).
"""
import os
import functools
import torch
