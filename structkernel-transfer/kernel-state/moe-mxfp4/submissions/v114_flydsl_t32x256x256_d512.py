...
"""
v114: FlyDSL t32x256x256_atomic stage2 for bs512/E33/d=512 with block_m=128.
Hypothesis: tile_n=256 halves N-tiles (28 vs 56), reducing atomic contention
on the output buffer with only 2 K-iterations for K=512.
"""
import os
import functools
import torch
...
# === bs=512/E=33/d=512: block_m=128 + 4-WG M128 stage1 + FlyDSL t32x256x256 stage2 ===
# tile_n=256 halves N-tiles (28 vs 56) for K=512 down-GEMM, reducing atomic contention.
