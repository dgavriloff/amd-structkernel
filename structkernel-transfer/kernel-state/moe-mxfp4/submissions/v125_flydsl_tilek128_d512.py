...
"""
v125: FlyDSL t32x128x128_atomic stage2 for d=512 (tile_k=128).
Monkeypatch _KERNEL_PARAMS to register tile_k=128 variant.
For K=512, tile_k=128 gives 4 iterations vs 2 with tile_k=256.
Smaller tile_k may reduce register pressure and improve occupancy.
"""
import os
import functools
import torch
