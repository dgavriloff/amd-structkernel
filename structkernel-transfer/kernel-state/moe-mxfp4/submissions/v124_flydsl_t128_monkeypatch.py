...
"""
v124: Monkeypatch _KERNEL_PARAMS to register FlyDSL t128x128x256_atomic stage2.
Server's _register_all_configs only has tile_m={32,64}. Inject tile_m=128 entry
directly so _flydsl_stage2_wrapper can find it. MLIR compiler should handle tile_m=128.
"""
import os
import functools
import torch
...
# Register FlyDSL tile_m=128 kernels that aren't in server's default registration
_flydsl_moe_kernels._KERNEL_PARAMS["flydsl_moe2_afp4_wfp4_bf16_t128x128x256_atomic"] = {
    "stage": 2, "a_dtype": "fp4", "b_dtype": "fp4", "out_dtype": "bf16",
    "tile_m": 128, "tile_n": 128, "tile_k": 256, "mode": "atomic", "MPerBlock": 128,
}
...
_FLYDSL_STAGE2_M128 = "flydsl_moe2_afp4_wfp4_bf16_t128x128x256_atomic"

_CUSTOM_CONFIGS[_make_key(512, 2048, 33)] = {
    "block_m": 128,
    "ksplit": 0,
    "kernelName1": _4WG_STAGE1_M128,
    "kernelName2": _FLYDSL_STAGE2_M128,  # v123: test tile_m=128 FlyDSL stage2
    "run_1stage": False,
}
