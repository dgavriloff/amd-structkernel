...
"""
v041: Try FlyDSL stage2 (reduce mode) for bs=512/E=33/d=2048.
Hypothesis: The default CK stage2 uses heuristic kernel selection for E=33 shapes.
FlyDSL stage2 with t128x256x256_reduce might be better for this shape with ~139 tokens/expert,
similar to how the tuned CSV uses FlyDSL stage2 for token>=1024 E=257 shapes.
"""
import torch
...
# === bs=512/E=33/d=2048: try FlyDSL stage2 with reduce mode ===
# ~139 tokens/expert, large enough for FlyDSL reduce mode to be efficient
_CUSTOM_CONFIGS[_make_key(512, 2048, 33)] = {
    "block_m": 128,
    "ksplit": 0,
    "kernelName1": "",
    "kernelName2": "flydsl_moe2_afp4_wfp4_bf16_t128x256x256_reduce",
    "run_1stage": False,
}

# NOTE: other bs=512/E=33 shapes are NOT injected (cktile_moe much worse for those)
