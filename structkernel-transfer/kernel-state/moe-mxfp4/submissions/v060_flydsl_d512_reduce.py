...
"""
v060: FlyDSL stage2 t32x128x256_reduce for bs512/E33/d=512.
v056 used atomic mode at 152µs. Try reduce mode which avoids atomic contention.
For d=2048, atomic beat reduce (v051 vs v048), but d=512 has different K dimension.
"""
import torch
...
# === bs=512/E=33/d=512: inject FlyDSL stage2 reduce mode ===
# v056 used t32x128x256_atomic at 152µs. Try reduce mode.
_FLYDSL_STAGE2_REDUCE = "flydsl_moe2_afp4_wfp4_bf16_t32x128x256_reduce"
_CUSTOM_CONFIGS[_make_key(512, 512, 33)] = {
    "block_m": 64,
    "ksplit": 0,
    "kernelName1": "",
    "kernelName2": _FLYDSL_STAGE2_REDUCE,
    "run_1stage": False,
}
