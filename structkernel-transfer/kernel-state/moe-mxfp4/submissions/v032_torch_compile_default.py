...
"""
v032: Try torch.compile with default mode on the fused_moe call.
v010 showed reduce-overhead mode fails with pickle error, but default mode
may still help by tracing and optimizing the Python dispatch + kernel launch.
Uses fullgraph=False to allow the compiled region to call into CK kernels.
"""
import torch
...
def _compiled_fused_moe(hidden_states, w1, w2, topk_weights, topk_ids,
