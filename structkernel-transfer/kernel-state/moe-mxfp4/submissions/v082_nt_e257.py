...
"""
v082: Non-temporal load for bs512/E257 via monkeypatch.
The tuned CSV path always sets use_non_temporal_load=False, but heuristic says NT=True
for 17 tokens/expert. Monkeypatch _get_moe_metadata_2stages to read NT from custom config.
"""
import os
import functools
import torch
