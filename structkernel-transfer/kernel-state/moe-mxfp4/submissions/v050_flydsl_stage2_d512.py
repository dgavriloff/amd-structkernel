...
"""
v050: FlyDSL stage2 for bs512/E33/d=512 + d=2048.
v048 showed FlyDSL t32x256x256_reduce improves d=2048 by -3.2% to -4.7%.
Now also try FlyDSL stage2 for d=512 (K=512, 2 K-iterations with tile_k=256).
bs512/E33/d=512 currently uses default heuristic at 214µs. FlyDSL reduce mode
may improve pipelining even with shorter K dimension.
"""
import torch
...
_FLYDSL_STAGE2 = "flydsl_moe2_afp4_wfp4_bf16_t32x256x256_reduce"
...
# Default heuristic gives 214µs. Try FlyDSL t32x256x256_reduce for stage2.
# K=512 for down-GEMM, so tile_k=256 gives 2 K-iterations.
