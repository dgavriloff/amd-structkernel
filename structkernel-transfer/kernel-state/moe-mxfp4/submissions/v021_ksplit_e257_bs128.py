...
"""
v021: Extend cktile_moe (ksplit=2) to E=257/bs=16 AND bs=128 shapes.
v020 proved bs=16/E=257 benefits from cktile_moe (-34.1%). Now try bs=128/E=257 too.
bs=128/E=257 has ~4.5 tokens/expert avg, similar to E=33 case where ksplit=2 helped.
"""
import torch
