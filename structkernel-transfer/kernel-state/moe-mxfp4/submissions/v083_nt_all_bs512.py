...
"""
v083: NT=True for all bs512 CK shapes via monkeypatch.
v082 showed NT=True helps bs512/E257 (-1.0%). Try NT=True for bs512/E33 CK stage1 too.
"""
import os
import functools
import torch
...
_CUSTOM_CONFIGS[_make_key(512, 2048, 33)] = {
    ...
    "run_1stage": False,
    "use_non_temporal_load": True,  # v083: try NT for CK stage1
}
