...
"""
v059: FlyDSL stage2 t32x128x256_atomic for bs128/E33/d=512.
Currently using cktile_moe ksplit=2 at 108µs. Try ck_moe 2-stage with
FlyDSL stage2 instead. FlyDSL gave -28.6% for bs512/E33/d512.
"""
import torch
...
# bs=128/E=33/d=512: try ck_moe 2-stage with FlyDSL stage2
# cktile_moe gives 108us, baseline 2-stage gives 124us
# FlyDSL stage2 gave -28.6% for bs512 same shape, may help here too
...
# === bs=512/E=33 shapes: inject 4-WG stage1 + FlyDSL stage2 ===
