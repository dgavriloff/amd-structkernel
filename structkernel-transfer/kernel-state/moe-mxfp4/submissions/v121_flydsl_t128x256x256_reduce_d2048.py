...
"""
v121: FlyDSL t128x256x256_reduce stage2 for d=2048 with block_m=128.
dsv3_fp4_tuned_fmoe.csv uses this exact kernel for token=2048/E=257.
v120 showed atomic mode not registered. Try reduce mode from dsv3 CSV.
"""
import os
import functools
import torch
...
_FLYDSL_STAGE2_REDUCE_M128 = "flydsl_moe2_afp4_wfp4_bf16_t128x256x256_reduce"

_CUSTOM_CONFIGS[_make_key(512, 2048, 33)] = {
    "block_m": 128,
    "ksplit": 0,
    "kernelName1": _4WG_STAGE1_M128,
    "kernelName2": _FLYDSL_STAGE2_REDUCE_M128,
    "run_1stage": False,
}
