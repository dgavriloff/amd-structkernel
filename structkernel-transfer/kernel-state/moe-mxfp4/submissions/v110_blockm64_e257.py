...
"""
v110: block_m=64 for bs512/E257 (instead of block_m=32).
With 17 tokens/expert, block_m=64 produces fewer tile groups (329 vs 401),
requiring 4 scheduling rounds vs 5. Heuristic prefers block_m=64 for this shape.
"""
import os
import functools
import torch
