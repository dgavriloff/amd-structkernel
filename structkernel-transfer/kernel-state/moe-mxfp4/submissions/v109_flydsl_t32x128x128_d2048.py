...
"""
v109: FlyDSL t32x128x128_atomic stage2 for d=2048 (tile_k=128 vs 256).
Smaller tile_k gives 16 K-iterations of 128 elements vs 8 of 256.
May reduce register pressure and improve occupancy for the down-GEMM (K=2048, N=7168).
"""
import os
import functools
import torch
