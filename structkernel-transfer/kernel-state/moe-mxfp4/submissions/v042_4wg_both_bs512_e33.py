...
"""
v042: Add 4-WG stage1 kernel (256x64x128x128_1x4) for bs=512/E=33/d=2048.
The 4-WG variant uses 4 workgroups per CU for better CU utilization on large shapes.
d=2048 goes from 7 tile rounds to 2, giving ~3% improvement on that shape.
d=512 tested but no improvement (flat at 213µs), so only d=2048 is injected.
"""
import torch
