...
"""
v020: Extend cktile_moe (ksplit=2) to E=257/bs=16 shape.
Hypothesis: bs=16/E=257 has <1 token/expert, so the a16w4 cktile_moe path
(which skips activation fp4x2 quantization overhead) should be faster.
Also keeps existing E=33 ksplit=2 optimizations from v018.
"""
import torch
