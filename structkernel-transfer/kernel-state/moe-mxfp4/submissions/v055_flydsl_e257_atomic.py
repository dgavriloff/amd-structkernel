...
"""
v055: FlyDSL stage2 t32x128x256_atomic for bs512/E257/d=256.
bs512/E257 uses tuned CSV at ~250µs. Try FlyDSL atomic for stage2.
The down-GEMM has K=256 (1 K-iteration with tile_k=256).
v033 showed reduce mode was +1.6% slower; atomic mode may differ.
"""
import torch
...
# === bs=512/E=257/d=256: inject FlyDSL stage2 atomic (keep tuned CSV stage1) ===
...
_FLYDSL_STAGE2_E257 = "flydsl_moe2_afp4_wfp4_bf16_t32x128x256_atomic"
