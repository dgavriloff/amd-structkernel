...
"""
v062: Combine sub-percent gains:
1. 4-WG stage1 for bs512/E33/d=512 (v057: -3.3% per-shape)
2. FlyDSL stage2 for bs512/E257/d=256 (v055: -0.8% per-shape)
Both combined should give ~0.5-0.6% geomean improvement.
"""
import torch
...
# === bs=512/E=33/d=512: inject 4-WG stage1 + FlyDSL stage2 ===
# v056: FlyDSL stage2 gives 152µs (-28.6% vs 213µs default).
# v057: 4-WG stage1 brings it to 147µs (-3.3%). Try combining both.
...
# === bs=512/E=257/d=256: inject FlyDSL stage2 ===
# v055: FlyDSL t32x128x256_atomic gives 249µs vs 251µs CK tuned (-0.8%)
