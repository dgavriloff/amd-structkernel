...
"""
v056: FlyDSL stage2 t32x128x256_atomic for bs512/E33/d=512.
v050 tried t32x256x256_reduce for d=512 and got correctness failure.
Try t32x128x256_atomic instead - smaller tile_n and atomic mode may work.
d=512 down-GEMM: M=~57 tokens/expert, N=7168, K=512 (2 K-iterations with tile_k=256).
"""
import torch
