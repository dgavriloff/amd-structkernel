...
"""
v044: Try block_m=32 instead of 64 for d=2048 with 4-WG stage1 kernel.
block_m=32 creates less padding (max_tokens=5655 vs 6711), reducing tile count.
Stage1: 89 tiles (2 rounds) same as v042. Stage2: 89 tiles (5 rounds vs v042's 6).
"""
import torch
