...
"""
v061: FlyDSL stage2 t32x256x128_atomic for bs512/E33/d=512.
Try tile_k=128 instead of tile_k=256. For d=512 down-GEMM (K=512):
  - tile_k=256: 2 K-iterations, 56 N-blocks (tile_n=128)
  - tile_k=128: 4 K-iterations, 28 N-blocks (tile_n=256)
More K-iterations may hide memory latency. For d=2048 (K=2048):
  - tile_k=128: 16 K-iterations vs 8 with tile_k=256
"""
import torch
...
_FLYDSL_STAGE2_D2048 = "flydsl_moe2_afp4_wfp4_bf16_t32x128x256_atomic"
_FLYDSL_STAGE2_D512 = "flydsl_moe2_afp4_wfp4_bf16_t32x256x128_atomic"

_CUSTOM_CONFIGS[_make_key(512, 2048, 33)] = {
    "block_m": 64,
    "ksplit": 0,
    "kernelName1": _4WG_STAGE1,
    "kernelName2": _FLYDSL_STAGE2_D2048,
    "run_1stage": False,
}

# === bs=512/E=33/d=512: inject FlyDSL stage2 with tile_k=128 ===
# v056 used t32x128x256_atomic (152µs). Try t32x256x128_atomic.
# Down-GEMM: K=512, tile_k=128 -> 4 K-iterations. N=7168, tile_n=256 -> 28 N-blocks.
_CUSTOM_CONFIGS[_make_key(512, 512, 33)] = {
    "block_m": 64,
    "ksplit": 0,
    "kernelName1": "",
    "kernelName2": _FLYDSL_STAGE2_D512,
    "run_1stage": False,
}
