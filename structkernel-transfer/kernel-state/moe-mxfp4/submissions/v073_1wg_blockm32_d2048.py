...
"""
v073: 1-WG stage1 (64x32x32x128_1x1) with block_m=32 for bs512/E33/d=2048.
v044 showed block_m=32 gives -12% for d=2048 but failed correctness because
MPerBlock != block_m. Here we explicitly use the 32-MPerBlock kernel to match.
block_m=32 means 2x more tile groups -> more parallelism for sorting/dispatch.
Gate-up GEMM: ~139 tokens/expert, N=4096, K=7168.
"""
import torch
...
# === bs=512/E=33 shapes ===
_1WG_STAGE1_32 = "moe_ck2stages_gemm1_64x32x32x128_1x1_MulABScaleShuffled_v3_Nswizzle0_Quant3_MulRoutedWeight0_silu_FP4X2_FP4X2_B16"

_FLYDSL_STAGE2 = "flydsl_moe2_afp4_wfp4_bf16_t32x128x256_atomic"

# d=2048: Use block_m=32 + 1-WG MPerBlock=32 stage1 + FlyDSL stage2
# v044 showed block_m=32 gives -12% for d=2048 (304-307µs vs 347µs).
# It failed because block_m != MPerBlock. Here block_m=32 matches MPerBlock=32.
_CUSTOM_CONFIGS[_make_key(512, 2048, 33)] = {
    "block_m": 32,
    "ksplit": 0,
    "kernelName1": _1WG_STAGE1_32,
