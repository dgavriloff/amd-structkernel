...
"""
v120: FlyDSL t128x256x256_atomic stage2 for d=2048 with block_m=128.
dsv3_fp4_tuned_fmoe.csv shows t128x256x256_reduce registered on server for cu_num=256.
Atomic mode with tile_m=128 should match block_m=128 perfectly (1 sub-tile per M-group).
"""
import os
import functools
import torch
...
_FLYDSL_STAGE2_M128 = "flydsl_moe2_afp4_wfp4_bf16_t128x256x256_atomic"

_CUSTOM_CONFIGS[_make_key(512, 2048, 33)] = {
    "block_m": 128,
    "ksplit": 0,
    "kernelName1": _4WG_STAGE1_M128,
    "kernelName2": _FLYDSL_STAGE2_M128,
    "run_1stage": False,
}
