...
"""
v065: FlyDSL stage2 t32x256x256_atomic for bs512/E257/d=256.
v033 tried t32x256x256_reduce -> +1.6% worse. v055 tried t32x128x256_atomic -> -0.8% (noise).
Try t32x256x256_atomic (atomic mode, larger tile_n) for this shape.
Down-GEMM: M=~18 tokens/expert, N=7168, K=256. tile_n=256 -> 28 N-blocks, tile_k=256 -> 1 K-iteration.
CK default has tile_n=32 -> 224 N-blocks, tile_k=128 -> 2 K-iterations.
"""
import torch
...
# === bs=512/E=257/d=256: inject FlyDSL stage2 (NEW in v065) ===
# v033 tried t32x256x256_reduce -> +1.6%. v055 tried t32x128x256_atomic -> -0.8% (noise).
# Try t32x256x256_atomic: tile_n=256 -> 28 N-blocks (vs CK's 224), tile_k=256 -> 1 K-iter (vs 2).
_FLYDSL_STAGE2_E257 = "flydsl_moe2_afp4_wfp4_bf16_t32x256x256_atomic"
_CUSTOM_CONFIGS[_make_key(512, 256, 257)] = {
    "block_m": 32,
    "ksplit": 0,
    "kernelName1": "",
    "kernelName2": _FLYDSL_STAGE2_E257,
    "run_1stage": False,
}
