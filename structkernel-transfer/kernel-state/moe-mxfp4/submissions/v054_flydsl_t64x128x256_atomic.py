...
"""
v054: FlyDSL stage2 t64x128x256_atomic for bs512/E33/d2048.
v052 showed t32x128x256_atomic gives 305µs. Try tile_m=64 to match block_m=64
for potentially better alignment with sorting blocks.
"""
import torch
...
_FLYDSL_STAGE2 = "flydsl_moe2_afp4_wfp4_bf16_t64x128x256_atomic"
