...
"""
v102: 1-WG CK stage1 + block_m=32 for bs512/E33/d=512.
With 139 tokens/expert, block_m=32 gives 92% tile utilization vs 72% with block_m=64.
The 1-WG 64x32x32x128_1x1 kernel has lower per-tile overhead than 4-WG.
"""
import os
import functools
import torch
...
# === bs=512/E=33/d=512: 1-WG stage1 + FlyDSL stage2, block_m=32 ===
# With 139 tokens/expert: block_m=32 gives 92% tile utilization (139 mod 32 = 11 wasted)
# vs 72% with block_m=64 (139 mod 64 = 53 wasted). 1-WG 64x32 kernel matches block_m=32.
