...
"""
v027: Inject 256x64x128x128_1x4 tile for bs=512/E=33/d=2048 only.
v026 showed -5.7% improvement for d=2048 with this tile. d=512 was marginal.
Only inject for d=2048 to isolate the gain.
"""
import torch
...
# === bs=512/E=33/d=2048: inject 256x tile kernel (NEW in v027) ===
# v026 showed -5.7% for d=2048 with 256x64x128x128_1x4 stage1 tile.
