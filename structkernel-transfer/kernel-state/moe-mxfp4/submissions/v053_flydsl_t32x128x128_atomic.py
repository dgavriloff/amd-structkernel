...
"""
v053: FlyDSL stage2 t32x128x128_atomic for bs512/E33/d2048.
v052 showed t32x128x256 gives 305µs. Try tile_k=128 for potentially
less register pressure per tile with K=2048 (16 K-iterations vs 8).
"""
import torch
...
_FLYDSL_STAGE2 = "flydsl_moe2_afp4_wfp4_bf16_t32x128x128_atomic"
