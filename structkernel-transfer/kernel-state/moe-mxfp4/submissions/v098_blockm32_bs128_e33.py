...
"""
v098: block_m=32 for cktile_moe bs128/E33/d=512.
Currently uses block_m=64 with ksplit=2. block_m=32 creates more tile groups
but each with fewer tokens, potentially better GPU occupancy.
bs16/E33 already uses block_m=32. Try matching for bs128.
"""
import os
import functools
import torch
...
# v098: try block_m=32 (same as bs16/E33) for more tile groups with fewer tokens each
