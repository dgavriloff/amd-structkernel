...
"""
v093: 4-WG stage1 + FlyDSL stage2 for bs512/E33/d=512.
v076 tested 4-WG with block_m=32 -> +13.8%. This tests with block_m=64.
"""
import os
import functools
import torch
...
# === bs=512/E=33/d=512: v093 4-WG stage1 + FlyDSL stage2 ===
# v076 tried 4-WG + block_m=32 -> +13.8%. Now try 4-WG + block_m=64.
