...
"""
v030: Try block_m=32 for cktile_moe E=257 shapes (currently block_m=16).
For bs=16/E=257 with ksplit=2, there are 144 token-expert pairs. With block_m=32,
each tile processes 32 tokens instead of 16, potentially reducing tile launch overhead
and improving memory access patterns. The tradeoff is less fine-grained scheduling.
"""
import torch
...
# === E=257 shapes — try block_m=32 instead of block_m=16 ===
_CUSTOM_CONFIGS[_make_key(16, 256, 257)] = {
    "block_m": 32,   # was 16 in v021
    "ksplit": 2,
    "kernelName1": "",
    "kernelName2": "",
    "run_1stage": False,
