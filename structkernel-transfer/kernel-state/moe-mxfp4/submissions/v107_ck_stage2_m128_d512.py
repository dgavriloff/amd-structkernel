...
"""
v107: Test CK 4-WG M128 stage2 (256x128x128x128_1x4_v3) for d=512.
With block_m=128 (from v106), MPerBlock=128 stage2 alignment is correct.
FlyDSL t32x128x256_atomic was 135us for d=512. CK stage2 with larger tiles may differ.
"""
import os
import functools
import torch
...
_CK_STAGE2_M128 = "moe_ck2stages_gemm2_256x128x128x128_1x4_MulABScaleExpertWeightShuffled_v3_Nswizzle0_Quant3_MulRoutedWeight1_FP4X2_FP4X2_B16"
...
# === bs=512/E=33/d=512: block_m=128 + M128 stage1 + CK M128 stage2 ===
# Test CK 4-WG stage2 with MPerBlock=128 (aligned with block_m=128).
_CUSTOM_CONFIGS[_make_key(512, 512, 33)] = {
    "block_m": 128,
    "ksplit": 0,
    "kernelName1": _4WG_STAGE1_M128,
    "kernelName2": _CK_STAGE2_M128,
    "run_1stage": False,
}
