...
"""
v132: FlyDSL t32x256x64_atomic stage2 for d=512.
Untried combination: tile_n=256 (more N-data reuse) + tile_k=64 (smaller footprint).
For K=512: 8 K-iterations x 256 N-elements. Keep d=2048 as t32x256x128 (v127 winner).
"""
import os
import functools
import torch
...
_flydsl_moe_kernels._KERNEL_PARAMS["flydsl_moe2_afp4_wfp4_bf16_t32x256x64_atomic"] = {
    "stage": 2, "a_dtype": "fp4", "b_dtype": "fp4", "out_dtype": "bf16",
    "tile_m": 32, "tile_n": 256, "tile_k": 64, "mode": "atomic", "MPerBlock": 32,
}
...
_FLYDSL_STAGE2_N256_K64 = "flydsl_moe2_afp4_wfp4_bf16_t32x256x64_atomic"
...
_CUSTOM_CONFIGS[_make_key(512, 512, 33)] = {
    ...
    "ksplit": 0,
    "kernelName1": _4WG_STAGE1_M128,
    "kernelName2": _FLYDSL_STAGE2_N256_K64,  # v132: tile_n=256, tile_k=64 for d=512
    "run_1stage": False,
}
