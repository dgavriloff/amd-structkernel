...
"""
v018: Hybrid cktile_moe for small-batch E=33 shapes.
Inject ksplit=2 for bs=16 and bs=128 E=33/d=512 shapes to route through cktile_moe
path (32.8% and 12.9% faster respectively). Keep default ck_moe for bs=512 shapes
where cktile_moe is worse. E=257 shapes use tuned configs from CSV (unaffected).
"""
import torch
