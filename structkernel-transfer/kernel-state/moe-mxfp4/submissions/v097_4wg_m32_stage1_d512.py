...
"""
v097: 4-WG MPerBlock=32 stage1 for bs512/E33/d=512.
Uses 256x32x128x128_1x4 kernel: MPerBlock=32, NPerBlock=128, 4 workgroups.
With block_m=64 sorting and MPerBlock=32, each group of 64 rows processes as 2 sub-tiles.
Different from v093 (MPerBlock=64) and v076 (block_m=32).
"""
import os
import functools
import torch
...
# === bs=512/E=33/d=512: 4-WG MPerBlock=32 stage1 + FlyDSL stage2 ===
# v093 tried MPerBlock=64 4-WG -> +1.3% noise. v097 tries MPerBlock=32 4-WG.
# With block_m=64, each group processes as 2 sub-tiles of 32.
# NPerBlock=128 -> 8 N-tiles for N=1024, but 4-WG gives 4x parallelism.
