...
"""
v048: FlyDSL stage2 (t32x256x256_reduce) for bs512/E33/d2048.
The FlyDSL stage2 kernel was confirmed available on server (v033 used it for E=257).
For d=2048, stage2 has K=2048 which means 8 K-iterations per tile (vs K=256 for E=257).
This larger inner loop may provide better pipelining than CK auto-selected kernel.
Keeps 4-WG stage1 (256x64x128x128_1x4) for the same shape.
"""
import torch
