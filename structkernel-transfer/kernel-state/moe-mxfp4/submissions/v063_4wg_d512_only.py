...
"""
v063: Add 4-WG stage1 for bs512/E33/d=512 (only, no E=257 changes).
v057 showed d512: 147µs (-3.3%), v062 confirmed 151µs.
4-WG schedules 4 workgroups per CU for better utilization.
"""
import torch
...
# v056: FlyDSL stage2 gives 152µs. v057: adding 4-WG stage1 -> 147µs.
