...
"""
v026: Inject 256x CK tile kernel names for bs=512/E=33 shapes.
Default heuristic picks block_m=64 with empty kernel names.
Try the 256x64x128x128_1x4 stage1 tile used by the tuned E=257 configs.
This larger tile config (4 workgroups per CU) may improve throughput for
the many-token-per-expert E=33/bs=512 case.
"""
import torch
...
# === bs=512/E=33 shapes: inject 256x tile kernel names (NEW in v026) ===
# The 256x64x128x128_1x4 tile (4 workgroups/CU) processes more work per wave launch.
# Default empty kernelName lets CK pick, which may not choose the 256x variant.
...
# NOTE: bs=512/E=257 uses tuned CSV config (64x32x32x128_1x1)
