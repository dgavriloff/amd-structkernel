...
"""
v037: Restore sub-percent gain from v035b (4-WG stage1 for bs512/E33/d2048).
v035b showed -3.4% on target shape, -0.6% geomean. Previously reverted under 1%
threshold, now a KEEP under the 0.1% threshold rule.
"""
import torch
...
# === bs=512/E=33/d=2048: inject 4-WG stage1 kernel (from v035b) ===
# v035b showed -3.4% for this shape (349->337µs) with 256x64x128x128_1x4 stage1 tile.
# Default heuristic uses 64x32x32x128_1x1 which is suboptimal for this large shape.
...
# NOTE: bs=512/E=33/d=512 and bs=512/E=257 use default paths
