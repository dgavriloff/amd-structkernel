...
"""
v049: FlyDSL stage2 (t64x256x256_reduce) for bs512/E33/d2048.
v048 showed t32x256x256_reduce gives -3.2% on d=2048. Try t64 for larger tiles.
The larger tile_m=64 matches the block_m=64 sorting, reducing block boundary overhead.
"""
import torch
...
_FLYDSL_STAGE2 = "flydsl_moe2_afp4_wfp4_bf16_t64x256x256_reduce"
