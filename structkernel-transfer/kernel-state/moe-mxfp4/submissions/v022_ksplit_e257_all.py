...
"""
v022: Extend cktile_moe (ksplit=2) to ALL E=257 shapes (bs=16,128,512).
v020 proved bs=16/E=257: -34.1%, v021 proved bs=128/E=257: -18.9%.
Now try bs=512/E=257 too (~18 tokens/expert avg).
"""
import torch
...
# bs=512/E=257/d=256: try cktile_moe ksplit=2
# bs=512 has ~18 tokens/expert avg with E=257
