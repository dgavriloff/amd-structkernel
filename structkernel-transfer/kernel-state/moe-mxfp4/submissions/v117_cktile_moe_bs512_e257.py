...
"""
v117: Try cktile_moe ksplit=2 for bs512/E257 instead of CK 2-stage + NT=True.
With 17 tokens/expert, the sparse workload may benefit from cktile_moe's
fused quant+sort+GEMM approach, eliminating 2 separate kernel launches.
"""
import os
import functools
import torch
...
# === bs=512/E=257: try cktile_moe ksplit=2 ===
# With 17 tokens/expert, the sparse workload is similar to smaller batches where
# cktile_moe excels. The fused quant+sort+GEMM eliminates 2 separate kernel launches.
