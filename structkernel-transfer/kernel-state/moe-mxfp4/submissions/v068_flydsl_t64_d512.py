...
"""
v068: FlyDSL stage2 t64x128x256_atomic for bs512/E33/d=512.
Try tile_m=64 instead of tile_m=32 for the d=512 FlyDSL stage2.
d=512 down-GEMM: M=~57 tokens/expert, N=7168, K=512.
tile_m=64: 1 M-block/expert, 56 N-blocks = 56 tiles/expert. 33*56=1848 total, 8 rounds.
tile_m=32: 2 M-blocks/expert, 56 N-blocks = 112 tiles/expert. 33*112=3696 total, 15 rounds.
Fewer rounds with tile_m=64 might offset lower occupancy.
"""
import torch
...
_FLYDSL_STAGE2_T64 = "flydsl_moe2_afp4_wfp4_bf16_t64x128x256_atomic"
...
# === bs=512/E=33/d=512: inject FlyDSL stage2 with tile_m=64 ===
# v056 used t32x128x256_atomic -> 152us. Try t64x128x256_atomic.
# tile_m=64: 1 M-block/expert -> 56 tiles/expert -> 1848 total -> 8 rounds.
# tile_m=32: 2 M-blocks/expert -> 112 tiles/expert -> 3696 total -> 15 rounds.
_CUSTOM_CONFIGS[_make_key(512, 512, 33)] = {
    "block_m": 64,
    "ksplit": 0,
    "kernelName1": "",
    "kernelName2": _FLYDSL_STAGE2_T64,
    "run_1stage": False,
}
