...
"""
v064: FlyDSL stage2 t64x256x256_atomic for d=2048.
v049 tried t64x256x256_reduce (338µs, worse). v054 tried t64x128x256_atomic (326µs, worse).
Try t64x256x256_atomic - atomic mode avoids reduction kernel.
With tile_m=64: 139tokens/64=~2 M-blocks/expert. tile_n=256: 28 N-blocks.
"""
import torch
...
_FLYDSL_STAGE2_D512 = "flydsl_moe2_afp4_wfp4_bf16_t32x128x256_atomic"
_FLYDSL_STAGE2_D2048 = "flydsl_moe2_afp4_wfp4_bf16_t64x256x256_atomic"
