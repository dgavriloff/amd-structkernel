...
"""
v131: FlyDSL t32x128x64_atomic stage2 for d=512.
tile_k=64 gives 8 K-iterations for K=512 (vs 4 with tile_k=128).
Even smaller tile footprint may improve occupancy further.
"""
import os
import functools
import torch
...
_flydsl_moe_kernels._KERNEL_PARAMS["flydsl_moe2_afp4_wfp4_bf16_t32x256x128_reduce"] = {
    "stage": 2, "a_dtype": "fp4", "b_dtype": "fp4", "out_dtype": "bf16",
    "tile_m": 32, "tile_n": 256, "tile_k": 128, "mode": "reduce", "MPerBlock": 32,
}
_flydsl_moe_kernels._KERNEL_PARAMS["flydsl_moe2_afp4_wfp4_bf16_t32x128x64_atomic"] = {
    "stage": 2, "a_dtype": "fp4", "b_dtype": "fp4", "out_dtype": "bf16",
    "tile_m": 32, "tile_n": 128, "tile_k": 64, "mode": "atomic", "MPerBlock": 32,
}
...
# v125: try tile_k=128 for d=512 (K=512). 4 K-iterations vs 2 with tile_k=256.
_CUSTOM_CONFIGS[_make_key(512, 512, 33)] = {
    "block_m": 128,
    "ksplit": 0,
    "kernelName1": _4WG_STAGE1_M128,
    "kernelName2": "flydsl_moe2_afp4_wfp4_bf16_t32x128x64_atomic",  # v131: tile_k=64
    "run_1stage": False,
}
