...
"""
v105: Test 256x128x128x128_1x4 stage1 kernel with block_m=128 for bs512/E33/d=512.
With 139 tokens/expert, block_m=128 gives 2 tiles/expert (2 scheduling rounds on 256 CUs)
vs block_m=64's 3 tiles/expert (3 rounds). The larger MPerBlock kernel may have better
throughput per tile despite higher padding waste on the last tile.
"""
import os
import functools
import torch
