...
"""
v074: block_m=32 with auto-select stage1 + FlyDSL stage2 for d=2048.
v044 showed block_m=32 gives -12% per-shape for d=2048 but failed because
MPerBlock != block_m when using explicit 4-WG kernel. Here we use empty
kernelName1 so the CK auto-selector picks a 32-MPerBlock kernel.
"""
import torch
...
# d=2048: block_m=32 with auto-select stage1 kernel (64x32x32x128_1x1)
# + FlyDSL stage2. block_m=32 means less padding per expert.
