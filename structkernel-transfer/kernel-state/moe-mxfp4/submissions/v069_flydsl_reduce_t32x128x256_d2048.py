...
"""
v069: FlyDSL stage2 t32x128x256_reduce for bs512/E33/d=2048.
Test reduce mode with tile_n=128 for d=2048 (t32x256x256_reduce was 328us in v048,
t32x128x256_atomic is 303us in v056). Reduce+128 combination untried.
"""
import torch
import functools
