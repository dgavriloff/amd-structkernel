...
"""
v091: Test CK stage2 instead of FlyDSL for bs512/E33/d=512.
FlyDSL t32x128x256_atomic has K=512 -> only 2 K-iterations with tile_k=256.
Per-iteration overhead may dominate. CK stage2 may be better for small K.
"""
import os
import functools
import torch
...
# === bs=512/E=33/d=512: v091 - try CK default stage2 instead of FlyDSL ===
# FlyDSL t32x128x256_atomic has K=512 -> only 2 K-iterations. CK stage2 may be better.
