...
"""
v099: torch.inference_mode() decorator to skip autograd overhead.
Every tensor operation in fused_moe goes through autograd dispatch.
inference_mode() disables this, potentially reducing per-op CPU overhead.
"""
import os
import functools
import torch
