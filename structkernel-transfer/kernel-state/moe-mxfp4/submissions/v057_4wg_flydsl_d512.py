...
"""
v057: Add 4-WG stage1 kernel for bs512/E33/d=512 alongside FlyDSL stage2.
v056 showed FlyDSL stage2 gives -28.6% for d=512 with default stage1.
The 4-WG stage1 kernel (256x64x128x128_1x4) improved d=2048 by -3% in v042.
Try combining it with FlyDSL stage2 for d=512.
"""
import torch
...
# v056: FlyDSL stage2 alone gives 152µs (-28.6% vs 213µs default).
# Now try adding 4-WG stage1 to see if it compounds.
