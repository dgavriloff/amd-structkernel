...
"""
v092: Try cktile_moe (ksplit=2) for bs512/E33/d=512.
cktile_moe skips both input quant and inter-stage quant (saves ~2 Triton kernel launches).
Heuristic says ksplit=0 for this shape but quant overhead may dominate.
"""
import os
import functools
import torch
...
# === bs=512/E=33/d=512: v092 - try cktile_moe ksplit=2 ===
# cktile_moe skips both quant kernels. ksplit=2 splits K by 2 for stage1.
