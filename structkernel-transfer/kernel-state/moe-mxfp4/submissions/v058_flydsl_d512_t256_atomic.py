...
"""
v058: FlyDSL stage2 t32x256x256_atomic for bs512/E33/d=512.
v050 used t32x256x256_reduce and got correctness failure. Try atomic mode instead.
For d=2048, atomic beat reduce by -2.4% (v051 vs v048). May work for d=512 too.
"""
import torch
...
# === bs=512/E=33/d=512: inject FlyDSL stage2 t32x256x256_atomic ===
# v050 tried t32x256x256_reduce -> correctness failure. Try atomic mode instead.
# v056 showed t32x128x256_atomic gives 152µs. t32x256x256_atomic may be even better
# since tile_n=256 gives 28 N-blocks vs 56, reducing launch overhead.
_FLYDSL_STAGE2_256 = "flydsl_moe2_afp4_wfp4_bf16_t32x256x256_atomic"
_CUSTOM_CONFIGS[_make_key(512, 512, 33)] = {
    "block_m": 64,
    "ksplit": 0,
    "kernelName1": "",
    "kernelName2": _FLYDSL_STAGE2_256,
    "run_1stage": False,
}
