...
"""
v071: FlyDSL stage2 t32x256x256_atomic for bs512/E257/d=256.
v070 tried t32x128x256_atomic for E=257 -> +0.8% worse (253 vs 251us).
Try t32x256x256_atomic instead: larger tile_n=256 means 28 N-blocks (vs 56).
With K=256 and only 1 K-iteration, fewer N-blocks may reduce launch overhead.
"""
import torch
...
# === bs=512/E=257/d=256: inject CK stage1 + FlyDSL stage2 ===
# v070 tried t32x128x256_atomic -> +0.8% worse. Try t32x256x256_atomic.
# Down-GEMM: N=7168, K=256. tile_n=256 -> 28 N-blocks, tile_k=256 -> 1 K-iteration.
_CK_STAGE1_E257 = "moe_ck2stages_gemm1_64x32x32x128_1x1_MulABScaleShuffled_v3_Nswizzle0_Quant3_MulRoutedWeight0_silu_FP4X2_FP4X2_B16"
_FLYDSL_STAGE2_T256 = "flydsl_moe2_afp4_wfp4_bf16_t32x256x256_atomic"
_CUSTOM_CONFIGS[_make_key(512, 256, 257)] = {
    "block_m": 32,
    "ksplit": 0,
    "kernelName1": _CK_STAGE1_E257,
    "kernelName2": _FLYDSL_STAGE2_T256,
    "run_1stage": False,
}
