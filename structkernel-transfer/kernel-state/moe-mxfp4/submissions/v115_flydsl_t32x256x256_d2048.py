...
"""
v115: FlyDSL t32x256x256_atomic stage2 for d=2048 with block_m=128.
v088 tested this with block_m=64 (+7.7%). With block_m=128, fewer M-tile groups
(2 vs 3) -> fewer total atomic operations. tile_n=256 halves N-tiles (28 vs 56).
"""
import os
import functools
import torch
...
_FLYDSL_STAGE2_N256 = "flydsl_moe2_afp4_wfp4_bf16_t32x256x256_atomic"

_CUSTOM_CONFIGS[_make_key(512, 2048, 33)] = {
    "block_m": 128,
    "ksplit": 0,
    "kernelName1": _4WG_STAGE1_M128,
    "kernelName2": _FLYDSL_STAGE2_N256,
    "run_1stage": False,
}
