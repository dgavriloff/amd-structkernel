...
"""
v128: FlyDSL t32x256x128_atomic stage2 for BOTH d=512 AND d=2048.
v127 showed t32x256x128 is better than t32x128x128 for d=2048 (-2.7%).
Test same tile_n=256 for d=512.
"""
import os
import functools
import torch
...
# v128: try tile_n=256 + tile_k=128 for d=512 (same as d=2048 winner)
_CUSTOM_CONFIGS[_make_key(512, 512, 33)] = {
    "block_m": 128,
    "ksplit": 0,
    "kernelName1": _4WG_STAGE1_M128,
    "kernelName2": _FLYDSL_STAGE2_N256_K128,
    "run_1stage": False,
}
