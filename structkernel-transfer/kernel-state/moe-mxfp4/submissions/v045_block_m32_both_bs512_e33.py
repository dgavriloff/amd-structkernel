...
"""
v045: Also apply block_m=32 + 4-WG stage1 to d=512 shape.
v044 showed block_m=32 dramatically helps d=2048 (-12%). For d=512, block_m=32 reduces
padding (5655 vs 6711 max_tokens), saving 1 stage2 round (5 vs 6).
"""
import torch
...
# bs=512/E=33/d=512: try block_m=32 + 4-WG (saves 1 stage2 round vs heuristic's block_m=64)
