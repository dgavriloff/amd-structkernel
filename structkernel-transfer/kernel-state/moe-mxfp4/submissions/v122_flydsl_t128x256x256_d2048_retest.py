...
"""
v122: Re-test FlyDSL t128x256x256_atomic stage2 for d=2048.
v120 showed "Invalid FlyDSL kernel name" - testing if server aiter has been updated.
If not registered, fall back to v106 config automatically via try/except in kernel.
"""
import os
import functools
import torch
...
_FLYDSL_STAGE2_T128 = "flydsl_moe2_afp4_wfp4_bf16_t128x256x256_atomic"

_CUSTOM_CONFIGS[_make_key(512, 2048, 33)] = {
    "block_m": 128,
    "ksplit": 0,
    "kernelName1": _4WG_STAGE1_M128,
    "kernelName2": _FLYDSL_STAGE2_T128,
    "run_1stage": False,
}
