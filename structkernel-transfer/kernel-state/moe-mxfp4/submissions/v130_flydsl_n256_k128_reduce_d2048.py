...
"""
v130: FlyDSL t32x256x128_reduce stage2 for d=2048.
v127 showed t32x256x128_atomic is best. Try reduce mode: separate reduction pass
may be faster than atomic accumulation for block_m=128 (4 M-subtiles).
"""
import os
import functools
import torch
...
_CUSTOM_CONFIGS[_make_key(512, 2048, 33)] = {
    ...
    "kernelName2": "flydsl_moe2_afp4_wfp4_bf16_t32x256x128_reduce",  # v130: reduce mode
    "run_1stage": False,
}
