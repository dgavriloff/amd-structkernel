...
"""
v066: Combined improvements: FlyDSL stage2 for bs512/E257 + 4-WG stage1 for d=512.
v055 showed t32x128x256_atomic for E257 gave 249us vs 251us (-0.8%, noise).
v057 showed 4-WG stage1 for d=512 gave 147us vs 152us (-3.3%).
Combined for compound effect.
"""
import torch
...
# === bs=512/E=33/d=512: inject 4-WG stage1 + FlyDSL stage2 (v066) ===
# v057 showed 4-WG stage1 alone gave d512: 147us (-3.3% from 152us).
# Combine with FlyDSL stage2 that already works well.
...
# === bs=512/E=257/d=256: inject FlyDSL stage2 (v066) ===
# v055 showed t32x128x256_atomic gave 249us vs 251us CK (-0.8%).
# Down-GEMM: N=7168, K=256. tile_n=128 -> 56 N-blocks, tile_k=256 -> 1 K-iter.
