...
"""
v079: FlyDSL stage2 t128x128x256_atomic for d=2048 (larger tile_m=128).
tile_m=128 never tried on server. With ~139 tokens/expert, creates only 2 M-blocks
per expert (vs 5 with tile_m=32), reducing dispatch overhead. tile_n=128 confirmed
optimal for d=2048 (v052). Keep t32x128x256_atomic for d=512 (confirmed optimal).
"""
import torch
...
_FLYDSL_STAGE2_T128 = "flydsl_moe2_afp4_wfp4_bf16_t128x128x256_atomic"
