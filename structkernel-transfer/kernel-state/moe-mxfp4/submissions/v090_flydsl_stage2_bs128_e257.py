...
"""
v090: Test CK 2-stage with FlyDSL stage2 for bs128/E257 instead of cktile_moe (ksplit=2).
bs128/E257 has ~4.5 tokens/expert avg. Currently uses cktile_moe which is -18.9% faster
than CK 2-stage (v021), but FlyDSL stage2 may close the gap.
"""
import os
import functools
import torch
...
# bs=128/E=257/d=256: v090 - try CK 2-stage with FlyDSL stage2 instead of cktile_moe
# bs=128 has ~4.5 tokens/expert avg. cktile_moe (ksplit=2) gives 175µs.
# Test if CK 2-stage + FlyDSL stage2 can match or beat it.
