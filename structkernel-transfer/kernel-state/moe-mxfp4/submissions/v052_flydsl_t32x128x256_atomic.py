...
"""
v052: FlyDSL stage2 t32x128x256_atomic for bs512/E33/d2048.
v051 showed t32x256x256_atomic gives 320µs. Try tile_n=128 for potentially
better occupancy with N=7168 (56 tiles vs 28 with tile_n=256).
"""
import torch
