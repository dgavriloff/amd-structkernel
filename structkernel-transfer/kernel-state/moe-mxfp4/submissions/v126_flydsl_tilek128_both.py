...
"""
v126: FlyDSL t32x128x128_atomic stage2 for BOTH d=512 AND d=2048.
v125 showed -6.7% for d=512 with tile_k=128. For d=2048, K=2048 gives
16 K-iterations vs 8 with tile_k=256. Test if reduced tile footprint helps.
"""
import os
import functools
import torch
...
_CUSTOM_CONFIGS[_make_key(512, 2048, 33)] = {
    ...
    "kernelName2": _FLYDSL_STAGE2_K128,  # v126: tile_k=128 for d=2048
    "run_1stage": False,
}
