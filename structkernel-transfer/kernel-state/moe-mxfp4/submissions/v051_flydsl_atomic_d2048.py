...
"""
v051: FlyDSL stage2 atomic mode (t32x256x256_atomic) for bs512/E33/d2048.
v048 used reduce mode which gave -3.2% to -4.7%. Atomic mode avoids the reduction
overhead by atomically accumulating into output, which may be faster when there
are many experts contributing to the same token position.
"""
import torch
...
_FLYDSL_STAGE2 = "flydsl_moe2_afp4_wfp4_bf16_t32x256x256_atomic"
